...
namespace PInvoke
{
    ...
    public static partial class BCrypt
    {
        ...
        /// </param>
        /// <param name="pbSecret">
        /// A pointer to a buffer that contains the key to use for the hash or MAC. The <paramref name="cbSecret"/> parameter contains the size of this buffer. This key only applies to hash algorithms opened by the BCryptOpenAlgorithmProvider function by using the <see cref="BCryptOpenAlgorithmProviderFlags.BCRYPT_ALG_HANDLE_HMAC_FLAG"/> flag. Otherwise, set this parameter to NULL.
        /// </param>
        /// <param name="cbSecret">
