...
namespace PInvoke
{
	...
	public partial class BCrypt : IBCryptMockable {        /// <summary>
        ...
        public NTStatus InvokeBCryptGenerateSymmetricKey(
			...
			=> BCryptGenerateSymmetricKey(hAlgorithm, phKey, pbKeyObject, cbKeyObject, pbSecret, cbSecret, flags );
        ...
        public NTStatus InvokeBCryptImportKeyPair(
			...
			=> BCryptImportKeyPair(hAlgorithm, hImportKey, pszBlobType, phKey, pbInput, cbInput, dwFlags);
        ...
        public NTStatus InvokeBCryptSecretAgreement(
			...
			=> BCryptSecretAgreement(privateKey, publicKey, secret, flags );
        ...
        public NTStatus InvokeBCryptDeriveKey(
			...
			=> BCryptDeriveKey(sharedSecret, keyDerivationFunction, kdfParameters, derivedKey, derivedKeySize, resultSize, flags);
        ...
        public NTStatus InvokeBCryptGetProperty(
			...
			=> BCryptGetProperty(hObject, property, output, outputSize, resultSize, flags );
