...
namespace PInvoke
{
	...
	class BCryptMockable : IBCrypt {        /// <summary>
        ...
        /// </returns>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptOpenAlgorithmProvider(
            out SafeAlgorithmHandle phAlgorithm,
            string pszAlgId,
            string pszImplementation,
            BCryptOpenAlgorithmProviderFlags dwFlags)
			=> BCryptOpenAlgorithmProvider(out phAlgorithm, pszAlgId, pszImplementation, dwFlags);
        ...
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptCreateHash(
			...
			=> BCryptCreateHash(hAlgorithm, out phHash, pbHashObject, cbHashObject, pbSecret, cbSecret, dwFlags);
		...
		public NTStatus BCryptEncrypt(
			...
			=> BCryptEncrypt(hKey, pbInput, cbInput, pPaddingInfo, pbIV, cbIV, pbOutput, cbOutput, out pcbResult, dwFlags);
		...
		public NTStatus BCryptDecrypt(
            ...
            out int pcbResult,
            BCryptEncryptFlags dwFlags)
			=> BCryptDecrypt(hKey, pbInput, cbInput, pPaddingInfo, pbIV, cbIV, pbOutput, cbOutput, out pcbResult, dwFlags);
        ...
        /// </remarks>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptHashData(
        ...
        /// <returns>Returns a status code that indicates the success or failure of the function.</returns>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptFinishHash(
            SafeHashHandle hHash,
        ...
        /// </remarks>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptSignHash(
            SafeKeyHandle hKey,
            IntPtr pPaddingInfo,
            byte[] pbInput,
            int cbInput,
			...
			=> BCryptSignHash(hKey, pPaddingInfo, pbInput, cbInput, pbOutput, cbOutput, out pcbResult, dwFlags);
        ...
        /// </returns>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptVerifySignature(
            SafeKeyHandle hKey,
            IntPtr pPaddingInfo,
            byte[] pbHash,
            int cbHash,
			...
			=> BCryptVerifySignature(hKey, pPaddingInfo, pbHash, cbHash, pbSignature, cbSignature, dwFlags );
        ...
        /// </remarks>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptGenerateKeyPair(
            SafeAlgorithmHandle hAlgorithm,
            out SafeKeyHandle phKey,
            int dwLength,
            BCryptGenerateKeyPairFlags dwFlags = BCryptGenerateKeyPairFlags.None)
			=> BCryptGenerateKeyPair(hAlgorithm, out phKey, dwLength, dwFlags );
        ...
        /// <returns>Returns a status code that indicates the success or failure of the function.</returns>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptGenerateSymmetricKey(
            SafeAlgorithmHandle hAlgorithm,
            out SafeKeyHandle phKey,
            byte[] pbKeyObject,
            int cbKeyObject,
			...
			=> BCryptGenerateSymmetricKey(hAlgorithm, out phKey, pbKeyObject, cbKeyObject, pbSecret, cbSecret, flags );
        ...
        /// </remarks>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptFinalizeKeyPair(
            SafeKeyHandle hKey,
        ...
        /// <returns>Returns a status code that indicates the success or failure of the function.</returns>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptDestroyKey(
            IntPtr hKey)
        ...
        /// <returns>Returns a status code that indicates the success or failure of the function.</returns>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptDestroySecret(
            IntPtr hSecret)
        ...
        /// <returns>Returns a status code that indicates the success or failure of the function.</returns>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptImportKey(
            SafeAlgorithmHandle hAlgorithm,
			...
			=> BCryptImportKey(hAlgorithm, hImportKey, pszBlobType, out phKey, pbKeyObject, cbKeyObject, pbInput, cbInput, dwFlags );
        ...
        /// <returns>Returns a status code that indicates the success or failure of the function.</returns>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptImportKeyPair(
            SafeAlgorithmHandle hAlgorithm,
            SafeKeyHandle hImportKey,
            [MarshalAs(UnmanagedType.LPWStr)] string pszBlobType,
            out SafeKeyHandle phKey,
			...
			=> BCryptImportKeyPair(hAlgorithm, hImportKey, pszBlobType, out phKey, pbInput, cbInput, dwFlags);
        ...
        /// <returns>Returns a status code that indicates the success or failure of the function.</returns>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptExportKey(
            SafeKeyHandle hKey,
			...
			=> BCryptExportKey(hKey, hExportKey, pszBlobType, pbOutput, cbOutput, out pcbResult, dwFlags );
        ...
        /// <returns>Returns a status code that indicates the success or failure of the function.</returns>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptSecretAgreement(
			...
			=> BCryptSecretAgreement(privateKey, publicKey, out secret, flags );
        ...
        /// </returns>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptDeriveKey(
			...
			=> BCryptDeriveKey(sharedSecret, keyDerivationFunction, ref kdfParameters, derivedKey, derivedKeySize, out resultSize, flags);
        ...
        /// <returns>Returns a status code that indicates the success or failure of the function.</returns>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptGetProperty(
            SafeHandle hObject,
            string property,
			...
			=> BCryptGetProperty(hObject, property, output, outputSize, out resultSize, flags );
        ...
        /// <returns>Returns a status code that indicates the success or failure of the function.</returns>
        [System.Runtime.CompilerServices.CompilerGenerated]
		public NTStatus BCryptGenRandom(
            SafeAlgorithmHandle hAlgorithm,
            byte[] pbBuffer,
            int cbBuffer,
            BCryptGenRandomFlags flags = BCryptGenRandomFlags.None)
			=> BCryptGenRandom(hAlgorithm, pbBuffer, cbBuffer, flags );
	}
}
