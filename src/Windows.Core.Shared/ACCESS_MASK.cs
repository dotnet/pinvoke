...
// Disable StyleCop warning: Do not use regions
...
namespace PInvoke
{
    ...
    public partial struct ACCESS_MASK : IComparable, IComparable<ACCESS_MASK>, IEquatable<ACCESS_MASK>, IFormattable
    {
        ...
        #region Basic rights from Kernel32
        ...
        #endregion Basic rights from Kernel32

        #region Desktop objects rights
        ...
        #endregion Desktop objects rights

        #region Window Staiton objects rights
        ...
        #endregion Window Station objects rights
        ...
        #region Basic rights from Kernel32 acessors
        ...
        #endregion Basic rights from Kernel32 acessors

        #region Desktop objects rights acessors
        ...
        /// </summary>
        public DesktopSpecificRight DesktopSpecificRights => (DesktopSpecificRight)(this.Value & SpecificRightsMask);

        #endregion Desktop objects rights acessors

        #region Window Station objects rights acessors
        ...
        /// </summary>
        public WindowStationSpecificRight WindowStationSpecificRights => (WindowStationSpecificRight)(this.Value & SpecificRightsMask);

        #endregion Window Station objects rights acessors
