...
namespace PInvoke
{
    ...
    public partial class Kernel32
    {
        ...
        public unsafe partial struct PROCESSENTRY32
        {
            ...
            /// <para>
            /// To retrieve the full path to the executable file, call the <see cref="Kernel32.Module32First"/> function and check the <see cref="MODULEENTRY32.szExePath"/> member
