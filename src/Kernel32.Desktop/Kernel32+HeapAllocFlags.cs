...
namespace PInvoke
{
    ...
    public partial class Kernel32
    {
        ...
        public enum HeapAllocFlags : uint
        {
            ...
            /// </summary>
            /// <remarks>
            /// To ensure that exceptions are generated for all calls to this function, specify HEAP_GENERATE_EXCEPTIONS in the call to <see cref="HeapCreate"/>.
            ...
            /// <remarks>
            /// <para>
            /// To ensure that serialized access is disabled for all calls to this function, specify HEAP_NO_SERIALIZE in the call to <see cref="HeapCreate"/>.
