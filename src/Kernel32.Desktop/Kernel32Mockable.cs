...
namespace PInvoke
{
    ...
    using System.Text;
	public partial class Kernel32 : IKernel32Mockable {
        /// <summary>
        ...
        public bool InvokeUpdateProcThreadAttribute(
			...
			=> UpdateProcThreadAttribute(lpAttributeList, dwFlags, Attribute, lpValue, cbSize, lpPreviousValue, lpReturnSize);
        ...
        /// </para>
        /// </remarks>
        public bool InvokeGetOverlappedResult(
            SafeObjectHandle hFile,
            OVERLAPPED* lpOverlapped,
