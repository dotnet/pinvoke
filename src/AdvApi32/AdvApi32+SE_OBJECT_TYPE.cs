...
namespace PInvoke
{
    ...
    public partial class AdvApi32
    {
        ...
        /// The functions, such as <see cref="GetSecurityInfo(System.IntPtr, SE_OBJECT_TYPE, SECURITY_INFORMATION, out void*, out void*, Kernel32.ACL*, Kernel32.ACL*, Kernel32.SECURITY_DESCRIPTOR*)"/> and <see cref="SetSecurityInfo(System.IntPtr, SE_OBJECT_TYPE, SECURITY_INFORMATION, void*, void*, Kernel32.ACL*, Kernel32.ACL*)"/>, that set and retrieve the security information of an object,
        ...
        public enum SE_OBJECT_TYPE
        {
            ...
            /// The <see cref="GetSecurityInfo(System.IntPtr, SE_OBJECT_TYPE, SECURITY_INFORMATION, out void*, out void*, Kernel32.ACL*, Kernel32.ACL*, Kernel32.SECURITY_DESCRIPTOR*)"/> and <see cref="SetSecurityInfo(System.IntPtr, SE_OBJECT_TYPE, SECURITY_INFORMATION, void*, void*, Kernel32.ACL*, Kernel32.ACL*)"/> functions support all types of kernel objects.
            /// The <see cref="GetNamedSecurityInfo(string, SE_OBJECT_TYPE, SECURITY_INFORMATION, out void*, out void*, Kernel32.ACL*, Kernel32.ACL*, Kernel32.SECURITY_DESCRIPTOR*)"/> and <see cref="SetNamedSecurityInfo(string, SE_OBJECT_TYPE, SECURITY_INFORMATION, void*, void*, Kernel32.ACL*, Kernel32.ACL*)"/> functions work only with the following kernel objects:
            /// <list>
            /// <item>semaphore</item>
            /// <item>event</item>
            /// <item>mutex</item>
            ...
            /// You cannot use <see cref="GetNamedSecurityInfo(string, SE_OBJECT_TYPE, SECURITY_INFORMATION, out void*, out void*, Kernel32.ACL*, Kernel32.ACL*, Kernel32.SECURITY_DESCRIPTOR*)"/> and <see cref="SetNamedSecurityInfo(string, SE_OBJECT_TYPE, SECURITY_INFORMATION, void*, void*, Kernel32.ACL*, Kernel32.ACL*)"/> with these objects because the names of window stations or desktops are not unique.
            /// </summary>
            SE_WINDOW_OBJECT,
