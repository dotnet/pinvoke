...
namespace PInvoke
{
    ...
    public enum NTStatus : uint
    {
        ...
        HIDP_STATUS_SUCCESS = NTStatusServerity.Success | NTStatusFacilities.HidErrorCode | 0,
        HIDP_STATUS_NULL = NTStatusServerity.Warning | NTStatusFacilities.HidErrorCode | 1,
        HIDP_STATUS_INVALID_PREPARSED_DATA = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 1,
        HIDP_STATUS_INVALID_REPORT_TYPE = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 2,
        HIDP_STATUS_INVALID_REPORT_LENGTH = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 3,
        HIDP_STATUS_USAGE_NOT_FOUND = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 4,
        HIDP_STATUS_VALUE_OUT_OF_RANGE = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 5,
        HIDP_STATUS_BAD_LOG_PHY_VALUES = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 6,
        HIDP_STATUS_BUFFER_TOO_SMALL = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 7,
        HIDP_STATUS_INTERNAL_ERROR = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 8,
        HIDP_STATUS_I8042_TRANS_UNKNOWN = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 9,
        HIDP_STATUS_INCOMPATIBLE_REPORT_ID = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 0xA,
        HIDP_STATUS_NOT_VALUE_ARRAY = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 0xB,
        HIDP_STATUS_IS_VALUE_ARRAY = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 0xC,
        HIDP_STATUS_DATA_INDEX_NOT_FOUND = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 0xD,
        HIDP_STATUS_DATA_INDEX_OUT_OF_RANGE = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 0xE,
        HIDP_STATUS_BUTTON_NOT_PRESSED = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 0xF,
        HIDP_STATUS_REPORT_DOES_NOT_EXIST = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 0x10,
        HIDP_STATUS_NOT_IMPLEMENTED = NTStatusServerity.Error | NTStatusFacilities.HidErrorCode | 0x20,
    }
}
