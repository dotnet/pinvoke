...
#pragma warning restore SA1303 // Const field names must begin with upper-case letter
        ...
        /// </summary>
        /// <param name="Process">A handle to the process. The handle must have the PROCESS_QUERY_INFORMATION or PROCESS_QUERY_LIMITED_INFORMATION access right. For more information, see <see cref="https://msdn.microsoft.com/de-de/library/windows/desktop/ms684880(v=vs.85).aspx"/></param>
