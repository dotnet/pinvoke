...
namespace PInvoke
{
    ...
    {
        /// <summary>
        /// Controls the behaviour of <see cref="CreateWindowStation(string, WindowStationCreationFlags, ACCESS_MASK, Kernel32.SECURITY_ATTRIBUTES?)" /> when a window station with the desired name already exists/>
        /// </summary>
