...
namespace PInvoke
{
	...
	using static NCrypt;
	public class NCryptMockable : INCryptMockable {        /// <summary>
        ...
        public SECURITY_STATUS InvokeNCryptCreatePersistedKey(
			...
			=> NCryptCreatePersistedKey(hProvider, out phKey, pszAlgId, pszKeyName , dwLegacyKeySpec , dwFlags );
        ...
        public SECURITY_STATUS InvokeNCryptGetProperty(
			...
			=> NCryptGetProperty(hObject, pszProperty, pbOutput, cbOutput, out pcbResult, dwFlags);
