...
namespace PInvoke
{
    ...
    /// <content>
    /// Contains the <see cref="NCryptDeleteKeyFlags"/> nested type.
    /// </content>
    public partial class NCrypt
    {
        /// <summary>
        /// The flags that may be passed to the <see cref="NCryptDeleteKey(SafeKeyHandle, NCryptDeleteKeyFlags)"/> method.
        /// </summary>
        [Flags]
        public enum NCryptDeleteKeyFlags
        {
            /// <summary>
            /// No flags.
            /// </summary>
