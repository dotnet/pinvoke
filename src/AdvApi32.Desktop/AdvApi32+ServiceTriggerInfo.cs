...
namespace PInvoke
{
    ...
    {
        /// <summary>
        /// Contains trigger event information for a service. This structure is used by the <see cref="ChangeServiceConfig2(SafeServiceHandle, ServiceInfoLevel, IntPtr)"/> and QueryServiceConfig2 functions.
        /// </summary>
