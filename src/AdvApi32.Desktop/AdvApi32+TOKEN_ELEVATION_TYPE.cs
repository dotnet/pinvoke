...
namespace PInvoke
{
    ...
    {
        /// <summary>
        /// Indicates the elevation type of token being queried by the <see cref="GetTokenInformation(Kernel32.SafeObjectHandle, TOKEN_INFORMATION_CLASS, System.IntPtr, int, out int)"/> function.
        /// </summary>
